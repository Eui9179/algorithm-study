package org.codingtest.score_kit.stackandqueue.p42587;
...
class Solution {
    ...
    public int solution(int[] priorities, int location) {
        ...
        Queue<Process> queue = new PriorityQueue<>((p1, p2) -> p2.priority - p1.priority);
        ...
        while (!queue.isEmpty() && !processes.isEmpty()) {
            ...
            if (!queue.isEmpty() && process.priority == queue.peek().priority) {
                result.add(process.index);
                queue.poll();
            } else {
