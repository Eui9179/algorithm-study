package org.codingtest.level1.p161989;

/*
어느 학교에 페인트가 칠해진 길이가 n미터인 벽이 있습니다. 벽에 동아리 · 학회 홍보나 회사 채용 공고 포스터 등을 게시하기 위해 테이프로 붙였다가 철거할 때
...
class Solution {
    public static void main(String[] args) {
        ...
        System.out.println(new Solution().solution(4,1, new int[]{1,2,3,6}));
        System.out.println(new Solution().solution(10,3, new int[]{1,3,6,7}));
    }
